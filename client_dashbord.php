...
<head>
    ...
    <link rel="stylesheet" href="/simplecoffee/simplecoffeeacademy/CSS/stylesdash.css">
...
<body>
    <div class="dashboard ">
        ...
        <div class="logo"><a href="/simplecoffee/simplecoffeeacademy/indexacademy.php" class="ri-arrow-left-circle-fill"></a></div>            <div class="sidebar-items">
            ...
            <section class="main-container">
                ...
                <div class="task-container d-grid margin-b">
                    <div class="exam card-1">
                        <p class="deadline">deadline 24:00</p>
                        <h2 class="exam">Exam - Unit 2</h2>
                        <p>Trainee</p>
                        <div class="start-testing-container d-flex">
                            <p>Are you ready?</p>
                            <a href="Course/index.html">Continue Your Courses</a>
                        </div>
                    </div>
                ...
                <div class="grammer-course d-grid ">
                    ...
                    <div class="course card-1 d-flex">
                        <div class="dictionary d-flex">
                            ...
                            <div>
                                <h3> </h3>
                                <p>+ 15 new tips in your career</p>
                            </div>
            ...
            <section class="secondary-container ">
                <div class="profile d-flex">
                    <div class="profile-img-box">
                        <img src="/images/pexels-ali-pazani-2613260.jpg" alt="">
                    </div>
                    <h2 class="name">marina shoshkin</h2>
                    <p>Barista</p>
